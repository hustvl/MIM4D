...
from ..utils.uni3d_voxelpooldepth import DepthNet,Uni3DVoxelPoolDepth
...
class UVTRDN(MVXTwoStageDetector):
    ...
    def forward_train(
        ...
        uni_feats = self.view_transform(img_feats, img_depth, pts_feats, img_metas)
        losses = dict()
    ...
    def simple_test(self, img_metas, points=None, img=None, rescale=False, **kwargs):
        ...
        img_feats = self.view_transform(img_feats, img_depth, pts_feats, img_metas)
