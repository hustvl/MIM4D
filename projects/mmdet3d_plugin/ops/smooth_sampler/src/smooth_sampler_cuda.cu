...
__global__ void smooth_sampler_backward_backward_kernel(
    const index_t nthreads,
    TensorInfo<scalar_t, index_t> grad_input, // initialized to empty
    TensorInfo<scalar_t, index_t> grad_grid, // initialized to zeros
    TensorInfo<scalar_t, index_t> grad_grad_out, // initialized to zeros
    TensorInfo<scalar_t, index_t> input,
    TensorInfo<scalar_t, index_t> grid,
    TensorInfo<scalar_t, index_t> grad_out_input,
    TensorInfo<scalar_t, index_t> grad_out_grid,
    TensorInfo<scalar_t, index_t> grad_output,
    const GridSamplerPadding padding_mode,
    bool align_corners,
    bool apply_smoothstep,
      ...
      if (at::native::canUse32BitIndexMath(input) && at::native::canUse32BitIndexMath(grid) && at::native::canUse32BitIndexMath(grad_output)
        ...
        smooth_sampler_backward_backward_kernel<scalar_t>
          ...
          <<<at::cuda::detail::GET_BLOCKS(count, 256), 256, 0, at::cuda::getCurrentCUDAStream()>>>(
            ...
            getTensorInfo<scalar_t, int>(grad_grid),
            getTensorInfo<scalar_t, int>(grad_grad_out),
            getTensorInfo<scalar_t, int>(input),
            getTensorInfo<scalar_t, int>(grid),
            input_requires_grad ? getTensorInfo<scalar_t, int>(grad_out_input) : TensorInfo<scalar_t, int>(),
            getTensorInfo<scalar_t, int>(grad_out_grid),
            getTensorInfo<scalar_t, int>(grad_output),
            static_cast<GridSamplerPadding>(padding_mode),
            align_corners,
            apply_smoothstep,
        ...
        smooth_sampler_backward_backward_kernel<scalar_t>
          ...
          <<<at::cuda::detail::GET_BLOCKS(count, 256), 256, 0, at::cuda::getCurrentCUDAStream()>>>(
            ...
            getTensorInfo<scalar_t, int64_t>(grad_grid),
            getTensorInfo<scalar_t, int64_t>(grad_grad_out),
            getTensorInfo<scalar_t, int64_t>(input),
            getTensorInfo<scalar_t, int64_t>(grid),
            input_requires_grad ? getTensorInfo<scalar_t, int64_t>(grad_out_input) : TensorInfo<scalar_t, int64_t>(),
            getTensorInfo<scalar_t, int64_t>(grad_out_grid),
            getTensorInfo<scalar_t, int64_t>(grad_output),
            static_cast<GridSamplerPadding>(padding_mode),
            align_corners,
            apply_smoothstep,
