...
frustum_range = [0, 0, 1.0, 800, 480, 60.0]
...
model = dict(
    ...
    img_backbone=dict(
        ...
        init_cfg=dict(
            type="Pretrained",
            checkpoint="ckpts/convnextS_1kpretrained_official_style.pth",
        ),
        mae_cfg=dict(
    ...
    render_conv_cfg=dict(in_channels=256, out_channels=32, kernel_size=3, padding=1),
    pts_bbox_head=dict(
        type="RenderHead",
        fp16_enabled=False,
        in_channels=256,
